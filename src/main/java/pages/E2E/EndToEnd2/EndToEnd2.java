...
public class EndToEnd2 extends BaseTest {
	public static void main(String[] args) throws InterruptedException {

		ExtentReports extent = ReportManager.getReportInstance();
		ExtentTest testReport = extent.createTest("TC - E2E 2");

		EndToEnd2 test = new EndToEnd2();
...
//----------------------------------------WOEKED------------------------------
            ...
            taskPage.fillRequisition("Requests using CGI france", "CGI FRANCE", "N020101" , "25" , "2" ,  DateUtils.getCurrentDate() , DateUtils.getFutureDate()  );
...
//----------------------------------------------------------------------------
			...
			Thread.sleep(4000);
			taskPage.addLine();
			taskPage.fillRequisitionForAddLine("Second item in the DA", "CGI FRANCE", "N020101" , "25", "2" ,  DateUtils.getCurrentDate() , DateUtils.getFutureDate());
			Thread.sleep(4000);
