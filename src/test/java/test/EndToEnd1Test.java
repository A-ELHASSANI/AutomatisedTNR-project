...
public class EndToEnd1Test extends BaseTest{
	...
	public void setUp() throws InterruptedException {
		...
		supplierPartNumber = config.get("e2e.requisition.supplierPartNumber");
    ...
    @Test(description = "TC-E2E1-01: Fill requisition and add to cart")
    public void step01_fillRequisition() {
        startTest("TC-E2E1-01: Fill requisition");

        requisitionForm.fillAmountLineWithContract(
            description, supplier, commodity,
            unitPrice, supplierPartNumber,
    ...
    @Test(description    = "TC-E2E1-02: Submit requisition for approval",
          dependsOnMethods = "step01_fillRequisition")
    public void step02_submitForApproval() {
        startTest("TC-E2E1-02: Submit for approval");
        ...
        pause(4000);
        requisitionBasket.editSelected();
    ...
    @Test(description    = "TC-E2E1-03: Approver 1 approves",
          dependsOnMethods = "step02_submitForApproval")
    public void step03_approver1() {
        startTest("TC-E2E1-03: " + approver1 + " approves");
    ...
    @Test(description    = "TC-E2E1-04: Approver 2 approves",
          dependsOnMethods = "step03_approver1")
    public void step04_approver2() {
        startTest("TC-E2E1-04: " + approver2 + " approves");
    ...
    @Test(description    = "TC-E2E1-05: Approver 3 approves",
          dependsOnMethods = "step04_approver2")
    public void step05_approver3() {
        startTest("TC-E2E1-05: " + approver3 + " approves");
	...
	@Test(description = "TC-E2E1-06: Record good receipt"
   		,dependsOnMethods = "step05_approver3")
	public void step06_goodReceipt() {
		startTest("TC-E2E1-06: Good receipt");
//───────── changed ─────────────────────────────────────────────────
		goodReceipt.receiveItems(DateUtils.getDatePlusTwo());
		pause(3000);
	...
	@Test(description = "TC-E2E1-07: Send invoice email and process invoice"
